      ...
      <div className="max-w-7xl mx-auto px-4 md:px-8 py-16">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-10">
          ...
          <div className="space-y-4 md:col-span-2 lg:col-span-1">
            ...
            <p className="font-raleway text-xs text-cream/40 uppercase tracking-wider">
          ...
          <div className="space-y-4">
            <h4 className="font-cinzel text-sm font-semibold tracking-widest uppercase text-gold">Shop</h4>
            ...
            <nav className="flex flex-col gap-3">
              ...
              <Link to="/shop?type=candle"
                className="font-raleway text-sm text-cream/70 hover:text-gold transition-colors duration-200">
                Candles
              </Link>
              <Link to="/shop?type=wax_melt"
                className="font-raleway text-sm text-cream/70 hover:text-gold transition-colors duration-200">
                Wax Melts
              </Link>
              <Link to="/shop?type=room_spray"
                className="font-raleway text-sm text-cream/70 hover:text-gold transition-colors duration-200">
                Room Sprays
              </Link>
              <Link to="/shop?type=car_freshener"
                className="font-raleway text-sm text-cream/70 hover:text-gold transition-colors duration-200">
                Car Fresheners
              </Link>
            </nav>
          ...
          <div className="space-y-4">
            ...
            <nav className="flex flex-col gap-3">
              ...
              <Link to="/shop?collection=Turnbow+Collection"
                className="font-raleway text-sm text-cream/70 hover:text-gold transition-colors duration-200">
                Turnbow Collection
              </Link>
              <Link to="/shop?collection=Coffee+House+Collection"
                className="font-raleway text-sm text-cream/70 hover:text-gold transition-colors duration-200">
          ...
          <div className="space-y-4">
            ...
            <div className="space-y-3">
              <a href="mailto:nativeflamecandles@gmail.com"
                className="flex items-start gap-3 font-raleway text-sm text-cream/70 hover:text-gold transition-colors duration-200 break-all">
