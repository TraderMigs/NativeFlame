      ...
      <div className="max-w-6xl mx-auto px-4 md:px-8 py-10">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-4 mb-10">
          ...
          <Link to="/admin/product-types"
            ...
            <div className="text-3xl">🗂️</div>
            <div>
              <h3 className="font-cinzel font-semibold text-mahogany tracking-wide group-hover:text-gold transition-colors">Shop Tabs</h3>
              <p className="font-raleway text-xs text-mahogany/50 mt-1">Add · Rename · Reorder · Hide tabs</p>
            </div>
          ...
          <Link to="/admin/collections"
            ...
            <div className="text-3xl">🏷️</div>
            <div>
              <h3 className="font-cinzel font-semibold text-mahogany tracking-wide group-hover:text-gold transition-colors">Collections</h3>
              <p className="font-raleway text-xs text-mahogany/50 mt-1">Add · Rename · Reorder · Hide collections</p>
            </div>
            <svg className="w-5 h-5 ml-auto text-mahogany/20 group-hover:text-gold transition-colors" fill="none" stroke="currentColor" viewBox="0 0 24 24">
              <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M9 5l7 7-7 7" />
            </svg>
          ...
          <Link to="/admin/shipping"
            ...
            <div className="text-3xl">🚚</div>
            <div>
              <h3 className="font-cinzel font-semibold text-mahogany tracking-wide group-hover:text-gold transition-colors">Shipping Settings</h3>
              <p className="font-raleway text-xs text-mahogany/50 mt-1">Free · Flat rate · Free over minimum</p>
            </div>
            <svg className="w-5 h-5 ml-auto text-mahogany/20 group-hover:text-gold transition-colors" fill="none" stroke="currentColor" viewBox="0 0 24 24">
              <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M9 5l7 7-7 7" />
            </svg>
          ...
          <Link to="/admin/promos"
            ...
            <div className="text-3xl">📣</div>
            <div>
              <h3 className="font-cinzel font-semibold text-mahogany tracking-wide group-hover:text-gold transition-colors">Promotions</h3>
              <p className="font-raleway text-xs text-mahogany/50 mt-1">Banners · Popups · Date-scheduled</p>
            </div>
            <svg className="w-5 h-5 ml-auto text-mahogany/20 group-hover:text-gold transition-colors" fill="none" stroke="currentColor" viewBox="0 0 24 24">
              <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M9 5l7 7-7 7" />
            </svg>
          ...
          <Link to="/admin/faq"
            ...
            <div className="text-3xl">❓</div>
            <div>
              <h3 className="font-cinzel font-semibold text-mahogany tracking-wide group-hover:text-gold transition-colors">FAQ Manager</h3>
              <p className="font-raleway text-xs text-mahogany/50 mt-1">Add · Edit · Reorder questions</p>
            </div>
            <svg className="w-5 h-5 ml-auto text-mahogany/20 group-hover:text-gold transition-colors" fill="none" stroke="currentColor" viewBox="0 0 24 24">
              <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M9 5l7 7-7 7" />
            </svg>
