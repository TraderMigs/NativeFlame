                ...
                <div className="flex-1 min-w-0">
                  <div className="flex items-start gap-2">
                    <div className="flex-1 min-w-0 overflow-hidden">
                      <h3 className="font-cinzel font-semibold text-mahogany truncate">{product.name}</h3>
                      <p className="font-raleway text-xs text-mahogany/40 mt-0.5 uppercase tracking-wider truncate">{product.collection}</p>
                    </div>
                    <div className="text-right shrink-0 flex flex-col items-end gap-0.5">
                      <p className="font-cinzel font-bold text-gold whitespace-nowrap">${Number(product.price).toFixed(2)}</p>
                      <p className={`font-raleway text-xs font-semibold whitespace-nowrap ${
